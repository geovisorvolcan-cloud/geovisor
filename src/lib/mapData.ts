...
export const DATA_POINTS: DataPoint[] = [
  ...
  { id: "GRAV33", position: [4.513380, -75.416595], type: "sgi_gravimetry", label: "GRAV33", acquired: false, description: "Vía Toche-Cajamarca, Finca Costarica. El vehículo puede acceder hasta el inicio del sendero de alrededor de 45 minutos ascendiendo hasta la finca. Presencia de cultivos de maíz." },
  { id: "GRAV39", position: [4.480143, -75.413131], type: "sgi_gravimetry", label: "GRAV39", acquired: false, description: "Vía Toche-Cajamarca." },
  { id: "GRAV41", position: [4.460143, -75.421915], type: "sgi_gravimetry", label: "GRAV41", acquired: false, description: "Vía Toche-Cajamarca, Finca Buenos Aires. El vehículo puede acceder hasta el inicio del sendero de alrededor de 50 minutos ascendiendo hasta la finca. El punto se encuentra ubicado pasando la Escuela El Espejo, hasta llegar a una Y tomando el sendero de la izquierda y en el próximo desvío a la derecha, subiendo por los cultivos de arracacha." },
  { id: "GRAV42", position: [4.456058, -75.419417], type: "sgi_gravimetry", label: "GRAV42", acquired: false, description: "Vía Toche-Cajamarca, Finca Buenos Aires. El vehículo puede acceder hasta el inicio del sendero de alrededor de 25 minutos ascendiendo hasta la finca. El punto se encuentra ubicado subiendo desde la Escuela El Espejo, vereda El Espejo." },
  { id: "GRAV43", position: [4.457754, -75.409517], type: "sgi_gravimetry", label: "GRAV43", acquired: false, description: "Vía Toche-Cajamarca, vereda Santa Ana. El punto se ubicó sobre el margen derecho de la vía." },
  ...
  { id: "MAG21", position: [4.450495, -75.371333], type: "sgi_magnetometry", label: "MAG21", acquired: false, description: "Vía Hostal Termales del Machín-Tapias, desvío a la derecha hacia la Finca de Ernesto Sierra. Al llegar a la finca se debe tomar un sendero de alrededor de 30 minutos que desciende hasta los cultivos de café y luego a los de plátano. El punto se encuentra ubicado en los cultivos de plátano." },
  ...
  { id: "MAG23", position: [4.452345, -75.357490], type: "sgi_magnetometry", label: "MAG23", acquired: false, description: "Vía Hostal Termales del Machín-Toche, desvío a la derecha en la Tienda El Moral. El punto se ubicó cerca a la vía ya que se encontró una zona con cultivos y vegetación densa." },
  ...
  { id: "MAG26", position: [4.462048, -75.353470], type: "sgi_magnetometry", label: "MAG26", acquired: false, description: "Vía Hostal Termales del Machín-Tapias, tomando el sendero de la quebrada Campamento hasta la Finca Balcones. El vehículo puede acceder hasta el inicio del sendero de alrededor de 30 minutos. El sendero es complicado en algunos tramos, se recomienda ir cuando no haya llovido." },
  ...
  { id: "MAG42", position: [4.513380, -75.416595], type: "sgi_magnetometry", label: "MAG42", acquired: false, description: "Vía Toche-Cajamarca, Finca Costarica. El vehículo puede acceder hasta el inicio del sendero de alrededor de 45 minutos ascendiendo hasta la finca. Presencia de cultivos de maíz." },
  { id: "MAG45", position: [4.460143, -75.421915], type: "sgi_magnetometry", label: "MAG45", acquired: false, description: "Vía Toche-Cajamarca, Finca Buenos Aires. El vehículo puede acceder hasta el inicio del sendero de alrededor de 50 minutos ascendiendo hasta la finca. El punto se encuentra ubicado pasando la Escuela El Espejo, hasta llegar a una Y tomando el sendero de la izquierda y en el próximo desvío a la derecha, subiendo por los cultivos de arracacha." },
  { id: "MAG46", position: [4.456058, -75.419417], type: "sgi_magnetometry", label: "MAG46", acquired: false, description: "Vía Toche-Cajamarca, Finca Buenos Aires. El vehículo puede acceder hasta el inicio del sendero de alrededor de 25 minutos ascendiendo hasta la finca. El punto se encuentra ubicado subiendo desde la Escuela El Espejo, vereda El Espejo." },
  { id: "MAG47", position: [4.457754, -75.409517], type: "sgi_magnetometry", label: "MAG47", acquired: false, description: "Vía Toche-Cajamarca, vereda Santa Ana. El punto se ubicó sobre el margen derecho de la vía." },
  ...
  { id: "MT07-GIDCO", position: [4.456875, -75.345412], type: "gidco", label: "MT07-GIDCO", acquired: false, description: "Vía Tapias-Ibagué, Finca de Los Buitrago. El vehículo puede acceder hasta la vía donde está la entrada de la finca. Presencia de potreros con vacas. Terreno con ladera inclinada ~30° al norte y plano al sur. Calcular el dipolo real." },
  ...
  { id: "MT12-GIDCO", position: [4.518089, -75.408417], type: "gidco", label: "MT12-GIDCO", acquired: false, description: "Vía Toche-Cajamarca, Finca Turística Las Delicias. El vehículo puede acceder hasta la entrada de la finca. Presencia de cercas eléctricas y potreros de vacas. Terreno mayormente plano." },
  { id: "MT13-GIDCO", position: [4.513959, -75.411999], type: "gidco", label: "MT13-GIDCO", acquired: false, description: "Vía Toche-Cajamarca, Finca Costarica. El vehículo puede acceder hasta el inicio del sendero de alrededor de 15 minutos hasta la finca. La pendiente de la zona es al rededor de 30°. Calcular el dipolo real." },
  { id: "MT14-GIDCO", position: [4.510099, -75.408771], type: "gidco", label: "MT14-GIDCO", acquired: false, description: "Vía Toche-Cajamarca, Finca Buritica. El vehículo puede acceder hasta el inicio del sendero de alrededor de 20 minutos hasta el punto. Presencia de cercas eléctricas y potreros de vacas. Terreno mayormente plano." },
  { id: "MT15-GIDCO", position: [4.505350, -75.414660], type: "gidco", label: "MT15-GIDCO", acquired: false, description: "Vía Toche-Cajamarca, Finca El Palmillo. El vehículo puede acceder hasta el inicio del sendero de alrededor de 25 minutos hasta el punto. Presencia de potreros de vacas. La pendiente de la zona es al rededor de 30°. Calcular el dipolo real." },
];
